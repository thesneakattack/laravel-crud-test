...
class App extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['_id', '_oldid', 'name', 'orgId', 'description', 'image', 'collections', 'mapCenterAddress', 'mapCenterAddressCoords_lat', 'mapCenterAddressCoords_lng', 'mainColor', 'secondaryColor'];
